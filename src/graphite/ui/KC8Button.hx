...
class KC8Button extends KC8Object
{
	...
	private var mcallback:KC8Button->Void;
	private var darken:Shape;
	private var over:Bool;
	
	public function new(_label:String = "default", _width:Int = 100, _height:Int = 20, m__callback:KC8Button->Void = null) 
	{
		super();
		
		background = new Shape();
		background.graphics.lineStyle(1, Std.parseInt(KC8UI.configOptions.chrome_color_1));
	...
	public function release(e:MouseEvent):Void 
	{
		...
		if (over == false)
			...
			darken.alpha = 0.05;
		if(mcallback != null && mouseX > 0 && mouseX < width && mouseY > 0 && mouseY < height)
			mcallback(this);
	}
