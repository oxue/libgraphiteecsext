...
class KC8Slider extends KC8Object
{
	private var background:Shape;
	private var block:KC8Button;
	...
	public function new(_maxValue:Int = 100, _width:Int = 100) 
	{
		...
		background.graphics.beginFill(KC8UI.configOptions.chrome_color_1);
		background.graphics.lineStyle(1, KC8UI.configOptions.chrome_color_3);
		background.graphics.drawRect(0, 0, _width, 20);
		addChild(background);
		
		block = new KC8Button('',20,20);
		block.graphics.lineStyle(1,KC8UI.configOptions.chrome_color_3);
		block.graphics.beginFill(KC8UI.configOptions.chrome_color_2);
