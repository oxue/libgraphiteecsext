...
int Reflect_obj::compare( Dynamic a,Dynamic b){
	HX_STACK_PUSH("Reflect::compare","C:\\HaxeToolkit\\haxe/std/cpp/_std/Reflect.hx",64);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(64)
...
bool Reflect_obj::isEnumValue( Dynamic v){
	HX_STACK_PUSH("Reflect::isEnumValue","C:\\HaxeToolkit\\haxe/std/cpp/_std/Reflect.hx",83);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(83)
	return (bool((v != null())) && bool((v->__GetType() == ::vtEnum)));
}
