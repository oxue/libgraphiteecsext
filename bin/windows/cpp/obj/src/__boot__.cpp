...
::graphite::ui::KC8UI_obj::__register();
::graphite::ui::KC8Button_obj::__register();
::graphite::std::StdComp_obj::__register();
::graphite::std::RandomCoordSub_obj::__register();
::graphite::std::RandomCoordComp_obj::__register();
::graphite::std::PositionSub_obj::__register();
::graphite::std::PositionComp_obj::__register();
::graphite::std::MouseCoordSub_obj::__register();
::graphite::std::MouseCoordComp_obj::__register();
::graphite::std::LerpSub_obj::__register();
::graphite::std::LerpComp_obj::__register();
::graphite::std::CoordinateComp_obj::__register();
::graphite::std::CircleSub_obj::__register();
::graphite::std::CircleComp_obj::__register();
::graphite::std::CircleCollisionSub_obj::__register();
::graphite::std::CircleCollisionComp_obj::__register();
::graphite::io::GraphicLoader_obj::__register();
::graphite::io::BinaryLoader_obj::__register();
::graphite::collections::ObjectPool_obj::__register();
::graphite::collections::Cons_obj::__register();
::graphite::SubManager_obj::__register();
::graphite::Sub_obj::__register();
::graphite::StateManager_obj::__register();
::graphite::KC8_obj::__register();
::graphite::Ent_obj::__register();
::graphite::Comp_obj::__register();
...
::graphite::State_obj::__register();
::Factory_obj::__register();
::DefaultAssetLibrary_obj::__register();
::openfl::AssetLibrary_obj::__register();
::DebugMenu_obj::__register();
::graphite::ui::KC8Pane_obj::__register();
::graphite::ui::KC8Frame_obj::__register();
::graphite::ui::KC8ObjectContainer_obj::__register();
::graphite::ui::KC8Object_obj::__register();
::Date_obj::__register();
...
::Date_obj::__boot();
::graphite::ui::KC8Object_obj::__boot();
::graphite::ui::KC8ObjectContainer_obj::__boot();
::graphite::ui::KC8Frame_obj::__boot();
::graphite::ui::KC8Pane_obj::__boot();
::DebugMenu_obj::__boot();
::openfl::AssetLibrary_obj::__boot();
::DefaultAssetLibrary_obj::__boot();
::Factory_obj::__boot();
::graphite::State_obj::__boot();
...
::graphite::Comp_obj::__boot();
::graphite::Ent_obj::__boot();
::graphite::KC8_obj::__boot();
::graphite::StateManager_obj::__boot();
::graphite::Sub_obj::__boot();
::graphite::SubManager_obj::__boot();
::graphite::collections::Cons_obj::__boot();
::graphite::collections::ObjectPool_obj::__boot();
::graphite::io::BinaryLoader_obj::__boot();
::graphite::io::GraphicLoader_obj::__boot();
::graphite::std::CircleCollisionComp_obj::__boot();
::graphite::std::CircleCollisionSub_obj::__boot();
::graphite::std::CircleComp_obj::__boot();
::graphite::std::CircleSub_obj::__boot();
::graphite::std::CoordinateComp_obj::__boot();
::graphite::std::LerpComp_obj::__boot();
::graphite::std::LerpSub_obj::__boot();
::graphite::std::MouseCoordComp_obj::__boot();
::graphite::std::MouseCoordSub_obj::__boot();
::graphite::std::PositionComp_obj::__boot();
::graphite::std::PositionSub_obj::__boot();
::graphite::std::RandomCoordComp_obj::__boot();
::graphite::std::RandomCoordSub_obj::__boot();
::graphite::std::StdComp_obj::__boot();
::graphite::ui::KC8Button_obj::__boot();
::graphite::ui::KC8UI_obj::__boot();
