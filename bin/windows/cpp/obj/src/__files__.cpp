...
const char *__hxcpp_all_files[] = {
	...
	"graphite/KC8.hx",
	"graphite/State.hx",
	"graphite/StateManager.hx",
	"graphite/Sub.hx",
	"graphite/SubManager.hx",
	"graphite/collections/Cons.hx",
	"graphite/collections/ObjectPool.hx",
	"graphite/io/BinaryLoader.hx",
	"graphite/io/GraphicLoader.hx",
	"graphite/std/CircleCollisionComp.hx",
	"graphite/std/CircleCollisionSub.hx",
	"graphite/std/CircleComp.hx",
	"graphite/std/CircleSub.hx",
	"graphite/std/CoordinateComp.hx",
	"graphite/std/LerpComp.hx",
	"graphite/std/LerpSub.hx",
	"graphite/std/MouseCoordComp.hx",
	"graphite/std/MouseCoordSub.hx",
	"graphite/std/PositionComp.hx",
	"graphite/std/PositionSub.hx",
	"graphite/std/RandomCoordComp.hx",
	"graphite/std/RandomCoordSub.hx",
	"graphite/ui/KC8Button.hx",
	"graphite/ui/KC8Frame.hx",
	"graphite/ui/KC8Object.hx",
	"graphite/ui/KC8ObjectContainer.hx",
	"graphite/ui/KC8Pane.hx",
	"graphite/ui/KC8UI.hx",
	"haxe/Timer.hx",
	"openfl/Assets.hx",
...
const char *__hxcpp_class_path[] = {
	...
	"src/",
	"C:\HaxeToolkit\haxe/lib\hxlibc/1,1,2/",
	"C:\HaxeToolkit\haxe/lib\openfl-native/1,2,1/",
	"C:\HaxeToolkit\haxe/lib\openfl/1,2,1/",
