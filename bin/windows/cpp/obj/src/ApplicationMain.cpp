...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("qwerber"),HX_CSTRING("newlibk"),HX_CSTRING("newlibk"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("newlibk"),null(),null());
	}
return null();
}
