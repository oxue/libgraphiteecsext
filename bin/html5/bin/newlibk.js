...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("img/spritesheet.png",loader);
...
Main.prototype = $extend(flash.display.Sprite.prototype,{
	...
	,done: function() {
		flash.Lib.get_current().get_stage().addChild(new DebugMenu());
		graphite.KC8.init(new GameState());
	}
	,init: function() {
		if(this.inited) return;
		this.inited = true;
		graphite.ui.KC8UI.init($bind(this,this.done));
	}
	,resize: function(e) {
...
var graphite = {}
graphite.ui = {}
graphite.ui.KC8Object = function() {
	flash.display.Sprite.call(this);
};
$hxClasses["graphite.ui.KC8Object"] = graphite.ui.KC8Object;
graphite.ui.KC8Object.__name__ = ["graphite","ui","KC8Object"];
graphite.ui.KC8Object.__super__ = flash.display.Sprite;
graphite.ui.KC8Object.prototype = $extend(flash.display.Sprite.prototype,{
	unload: function() {
		var gparent = js.Boot.__cast(this.parent , graphite.ui.KC8ObjectContainer);
		var index = flash._Vector.Vector_Impl_.lastIndexOf(gparent.children,this);
		gparent.children[index] = gparent.children[flash._Vector.Vector_Impl_.get_length(gparent.children) - 1];
		flash._Vector.Vector_Impl_.pop(gparent.children);
		this.parent.removeChild(this);
	}
	,load: function() {
	}
	,__class__: graphite.ui.KC8Object
});
graphite.ui.KC8ObjectContainer = function() {
	this.children = flash._Vector.Vector_Impl_._new();
	graphite.ui.KC8Object.call(this);
};
$hxClasses["graphite.ui.KC8ObjectContainer"] = graphite.ui.KC8ObjectContainer;
graphite.ui.KC8ObjectContainer.__name__ = ["graphite","ui","KC8ObjectContainer"];
graphite.ui.KC8ObjectContainer.__super__ = graphite.ui.KC8Object;
graphite.ui.KC8ObjectContainer.prototype = $extend(graphite.ui.KC8Object.prototype,{
	unload: function() {
		var $it0 = ((function(_e) {
			return function() {
		...
		graphite.ui.KC8Object.prototype.unload.call(this);
	}
	,addKC8Object: function(_o,_x,_y) {
		if(_y == null) _y = 0;
		if(_x == null) _x = 0;
		this.addChild(js.Boot.__cast(_o , flash.display.DisplayObject));
		flash._Vector.Vector_Impl_.push(this.children,_o);
		_o.load();
		_o.set_x(_x);
		_o.set_y(_y);
		return _o;
	...
	,__class__: graphite.ui.KC8ObjectContainer
});
graphite.ui.KC8Frame = function(_label,_width,_height) {
	if(_height == null) _height = 300;
	if(_width == null) _width = 400;
	if(_label == null) _label = "default";
	graphite.ui.KC8ObjectContainer.call(this);
	this.background = new flash.display.Sprite();
	this.background.get_graphics().lineStyle(1,Std.parseInt(graphite.ui.KC8UI.configOptions.chrome_color_3));
	this.background.get_graphics().beginFill(Std.parseInt(graphite.ui.KC8UI.configOptions.chrome_color_2));
	this.background.get_graphics().drawRect(0,0,_width,_height);
	this.addChild(this.background);
	this.label = new flash.text.TextField();
	this.label.set_defaultTextFormat(graphite.ui.KC8UI.textFormatLeft);
	this.label.set_text(_label);
	this.label.mouseEnabled = false;
	this.label.selectable = false;
	this.label.set_width(_width);
	this.label.set_x(5);
	this.label.set_y(10 - this.label.get_textHeight() * 0.5);
	this.addChild(this.label);
};
$hxClasses["graphite.ui.KC8Frame"] = graphite.ui.KC8Frame;
graphite.ui.KC8Frame.__name__ = ["graphite","ui","KC8Frame"];
graphite.ui.KC8Frame.__super__ = graphite.ui.KC8ObjectContainer;
graphite.ui.KC8Frame.prototype = $extend(graphite.ui.KC8ObjectContainer.prototype,{
	__class__: graphite.ui.KC8Frame
});
graphite.ui.KC8Pane = function(_label,_width,_height,_closeButton) {
	if(_closeButton == null) _closeButton = true;
	if(_height == null) _height = 300;
	if(_width == null) _width = 400;
	if(_label == null) _label = "default";
	graphite.ui.KC8Frame.call(this,_label,_width,_height);
	if(_closeButton) {
		var closeButton = new graphite.ui.KC8Button("X",20,20,$bind(this,this.KC8PaneUnload));
		this.addKC8Object(closeButton);
		closeButton.set_x(_width - 22);
		closeButton.set_y(2);
	}
	this.background.addEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.mouseDown));
	this.background.addEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.mouseUp));
};
$hxClasses["graphite.ui.KC8Pane"] = graphite.ui.KC8Pane;
graphite.ui.KC8Pane.__name__ = ["graphite","ui","KC8Pane"];
graphite.ui.KC8Pane.__super__ = graphite.ui.KC8Frame;
graphite.ui.KC8Pane.prototype = $extend(graphite.ui.KC8Frame.prototype,{
	...
	,unload: function() {
		this.background.removeEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.mouseDown));
		this.background.removeEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.mouseUp));
		graphite.ui.KC8Frame.prototype.unload.call(this);
	}
	,KC8PaneUnload: function(b) {
		this.unload();
	}
	,__class__: graphite.ui.KC8Pane
});
var DebugMenu = function() {
	graphite.ui.KC8Pane.call(this,"debug",400,300,false);
	haxe.Timer.delay($bind(this,this.reAdd),1000);
};
$hxClasses["DebugMenu"] = DebugMenu;
DebugMenu.__name__ = ["DebugMenu"];
DebugMenu.__super__ = graphite.ui.KC8Pane;
DebugMenu.prototype = $extend(graphite.ui.KC8Pane.prototype,{
	reAdd: function() {
...
Factory.createCircle = function(_x,_y,_radius,_color) {
	if(_color == null) _color = 0;
	if(_radius == null) _radius = 10;
	if(_y == null) _y = 0;
	if(_x == null) _x = 0;
	var e = new graphite.Ent();
	var p = graphite.KC8.subManager.get(graphite.std.StdComp.POSITION).get();
	p.x = _x;
	p.y = _y;
	...
	p.load();
	p;
	var c = graphite.KC8.subManager.get(graphite.std.StdComp.CIRCLE).get();
	c.radius = _radius;
	c.lineColor = _color;
	c.fillColor = _color;
	...
	c.load();
	c;
	e.add(new graphite.std.CoordinateComp());
	var l = graphite.KC8.subManager.get(graphite.std.StdComp.LERP).get();
	e.componentHash.set(l.id,l);
	l.entity = e;
	l.cache();
	l.load();
	l;
	e.add(graphite.KC8.subManager.get(graphite.std.StdComp.MOUSECOORDS).get());
	c.fillColor = 16755200;
	c.lineColor = 16755200;
	c.redraw();
	e.add(graphite.KC8.subManager.get(graphite.std.StdComp.CIRCLECOLLISION).get());
	return e;
}
Factory.prototype = {
	__class__: Factory
}
graphite.State = function() {
};
$hxClasses["graphite.State"] = graphite.State;
graphite.State.__name__ = ["graphite","State"];
graphite.State.prototype = {
	requestChange: function(_state) {
	...
	,__class__: graphite.State
}
var GameState = function() {
	graphite.State.call(this);
};
$hxClasses["GameState"] = GameState;
GameState.__name__ = ["GameState"];
GameState.__super__ = graphite.State;
GameState.prototype = $extend(graphite.State.prototype,{
	done: function() {
		flash.Lib.get_current().addChild(new flash.display.Bitmap(this.l.data));
	}
	,load: function() {
		console.log("hello Graphite!");
		graphite.KC8.subManager.addSub(new graphite.std.PositionSub());
		graphite.KC8.subManager.addSub(new graphite.std.CircleSub());
		graphite.KC8.subManager.addSub(new graphite.std.LerpSub());
		graphite.KC8.subManager.addSub(new graphite.std.MouseCoordSub());
		graphite.KC8.subManager.addSub(new graphite.std.CircleCollisionSub());
		graphite.KC8.subManager.addSub(new graphite.std.RandomCoordSub());
		Factory.createCircle(0,0,100,16711935);
		this.l = new graphite.io.GraphicLoader();
		this.l.load("graphite_logo.png",$bind(this,this.done));
	}
	,__class__: GameState
});
...
graphite.Comp = function(_id) {
	this.id = _id;
	this.dependencies = flash._Vector.Vector_Impl_._new();
	this.remove = false;
};
$hxClasses["graphite.Comp"] = graphite.Comp;
graphite.Comp.__name__ = ["graphite","Comp"];
graphite.Comp.prototype = {
	unload: function() {
	}
	,cache: function() {
	}
	...
	,getComponentCache: function(_id) {
		var component = this.entity.componentHash.get(_id);
		flash._Vector.Vector_Impl_.push(component.dependencies,this);
		return component;
	}
	,__class__: graphite.Comp
}
graphite.Ent = function() {
	this.componentHash = new haxe.ds.EnumValueMap();
};
$hxClasses["graphite.Ent"] = graphite.Ent;
graphite.Ent.__name__ = ["graphite","Ent"];
graphite.Ent.prototype = {
	remove: function() {
		var $it0 = ((function(_e) {
			return function() {
				return _e.iterator();
	...
	,swap: function(_component) {
		var oldComponent = this.componentHash.get(_component.id);
		this.componentHash.set(_component.id,_component);
		var i = flash._Vector.Vector_Impl_.get_length(oldComponent.dependencies);
		while(i-- > 0) oldComponent.dependencies[i].cache();
	...
	,__class__: graphite.Ent
}
graphite.KC8 = function() { }
$hxClasses["graphite.KC8"] = graphite.KC8;
graphite.KC8.__name__ = ["graphite","KC8"];
graphite.KC8.init = function(_state) {
	graphite.KC8.subManager = new graphite.SubManager();
	graphite.KC8.stateManager = new graphite.StateManager(_state);
	flash.Lib.get_current().get_stage().addEventListener(flash.events.Event.ENTER_FRAME,graphite.KC8.update);
}
graphite.KC8.update = function(e) {
	graphite.KC8.subManager.update();
	graphite.KC8.stateManager.currentState.update();
}
graphite.StateManager = function(_initialState) {
	this.currentState = _initialState;
	this.currentState.load();
};
$hxClasses["graphite.StateManager"] = graphite.StateManager;
graphite.StateManager.__name__ = ["graphite","StateManager"];
graphite.StateManager.prototype = {
	setState: function(_state) {
		this.currentState.unload();
		this.currentState = _state;
		this.currentState.load();
	}
	,requestStateChange: function(_state) {
		this.currentState.requestChange(_state);
	}
	,__class__: graphite.StateManager
}
graphite.Sub = function(_priority,_id) {
	_priority = this.priority;
	this.remove = false;
	this.id = _id;
};
$hxClasses["graphite.Sub"] = graphite.Sub;
graphite.Sub.__name__ = ["graphite","Sub"];
graphite.Sub.prototype = {
	wipe: function() {
	}
	,update: function() {
	}
	...
	,__class__: graphite.Sub
}
graphite.SubManager = function() {
	this.subs = null;
	this.subHash = new haxe.ds.EnumValueMap();
};
$hxClasses["graphite.SubManager"] = graphite.SubManager;
graphite.SubManager.__name__ = ["graphite","SubManager"];
graphite.SubManager.prototype = {
	update_h: function(_lst) {
		if(_lst == null) return null; else if(_lst.first.remove == true) {
			this.subHash.set(_lst.first.id,null);
			_lst.first.wipe();
			return _lst.rest;
		} else {
			_lst.first.update();
			return new graphite.collections.Cons(_lst.first,this.update_h(_lst.rest));
		}
	}
	,update: function() {
		this.update_h(this.subs);
	}
	,addsub_h: function(_sub,_lst) {
		if(_lst == null) {
			this.subHash.set(_sub.id,_sub);
			return new graphite.collections.Cons(_sub,null);
		} else if(_sub.priority > _lst.first.priority) {
			this.subHash.set(_sub.id,_sub);
			return new graphite.collections.Cons(_sub,_lst);
		} else return new graphite.collections.Cons(_lst.first,this.addsub_h(_sub,_lst.rest));
	}
	,addSub: function(_sub) {
		this.subs = this.addsub_h(_sub,this.subs);
	}
	,get: function(_id) {
		return this.subHash.get(_id);
	}
	,__class__: graphite.SubManager
}
graphite.collections = {}
graphite.collections.Cons = function(_first,_rest) {
	this.first = _first;
	this.rest = _rest;
};
$hxClasses["graphite.collections.Cons"] = graphite.collections.Cons;
graphite.collections.Cons.__name__ = ["graphite","collections","Cons"];
graphite.collections.Cons.list = function(_values) {
	var ret = new graphite.collections.Cons(_values[_values.length - 1],null);
	var i = _values.length - 1;
	while(i-- > 0) {
		var c = new graphite.collections.Cons(_values[i],ret);
		ret = c;
	}
	return ret;
}
graphite.collections.Cons.prototype = {
	eight: function() {
	...
	,__class__: graphite.collections.Cons
}
graphite.collections.ObjectPool = function(_initialSize,_incremental) {
	if(_incremental == null) _incremental = 10;
	this.pool = flash._Vector.Vector_Impl_._new(_initialSize);
	this.incremental = _incremental;
	this.size = 0;
};
$hxClasses["graphite.collections.ObjectPool"] = graphite.collections.ObjectPool;
graphite.collections.ObjectPool.__name__ = ["graphite","collections","ObjectPool"];
graphite.collections.ObjectPool.prototype = {
	alloc: function(_o) {
		this.pool[this.size++];
		if(this.size == flash._Vector.Vector_Impl_.get_length(this.pool)) {
			var _g = this.pool;
			var value = flash._Vector.Vector_Impl_.get_length(_g) + this.incremental;
			if(value < _g.length) _g = _g.slice(0,value);
			while(value > _g.length) _g.push(null);
			value;
		}
	}
	,get: function() {
		if(this.size == 0) return null; else return this.pool[--this.size];
	}
	,__class__: graphite.collections.ObjectPool
}
graphite.io = {}
graphite.io.BinaryLoader = function() {
	this.data = new String("");
	this.loader = new flash.net.URLLoader();
};
$hxClasses["graphite.io.BinaryLoader"] = graphite.io.BinaryLoader;
graphite.io.BinaryLoader.__name__ = ["graphite","io","BinaryLoader"];
graphite.io.BinaryLoader.prototype = {
	loadComplete: function(e) {
		this.data = this.loader.data;
		this._callback();
	}
	,load: function(_url,__callback) {
		this._callback = __callback;
		this.request = new flash.net.URLRequest(_url);
		this.loader.addEventListener(flash.events.Event.COMPLETE,$bind(this,this.loadComplete));
		this.loader.load(this.request);
	}
	,__class__: graphite.io.BinaryLoader
}
graphite.io.GraphicLoader = function() {
	this.req = new flash.net.URLRequest();
	this.loader = new flash.display.Loader();
};
$hxClasses["graphite.io.GraphicLoader"] = graphite.io.GraphicLoader;
graphite.io.GraphicLoader.__name__ = ["graphite","io","GraphicLoader"];
graphite.io.GraphicLoader.prototype = {
	done: function(e) {
		this.data = (js.Boot.__cast(this.loader.content , flash.display.Bitmap)).bitmapData;
		this.mcallback();
	}
	,load: function(_url,__callback) {
		this.req.url = _url;
		this.mcallback = __callback;
		this.loader.contentLoaderInfo.addEventListener(flash.events.Event.COMPLETE,$bind(this,this.done));
		this.loader.load(this.req);
	}
	,__class__: graphite.io.GraphicLoader
}
graphite.std = {}
graphite.std.CircleCollisionComp = function() {
	graphite.Comp.call(this,graphite.std.StdComp.CIRCLECOLLISION);
};
$hxClasses["graphite.std.CircleCollisionComp"] = graphite.std.CircleCollisionComp;
graphite.std.CircleCollisionComp.__name__ = ["graphite","std","CircleCollisionComp"];
graphite.std.CircleCollisionComp.__super__ = graphite.Comp;
graphite.std.CircleCollisionComp.prototype = $extend(graphite.Comp.prototype,{
	cache: function() {
		this.position = this.getComponentCache(graphite.std.StdComp.POSITION);
		this.circle = this.getComponentCache(graphite.std.StdComp.CIRCLE);
	}
	,__class__: graphite.std.CircleCollisionComp
});
graphite.std.CircleCollisionSub = function() {
	this.circleCollisions = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
	graphite.Sub.call(this,6,graphite.std.StdComp.CIRCLECOLLISION);
};
$hxClasses["graphite.std.CircleCollisionSub"] = graphite.std.CircleCollisionSub;
graphite.std.CircleCollisionSub.__name__ = ["graphite","std","CircleCollisionSub"];
graphite.std.CircleCollisionSub.__super__ = graphite.Sub;
graphite.std.CircleCollisionSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = 1;
		while(i-- > 0) this.resolve();
	}
	,resolve: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.circleCollisions);
		var l = i;
		while(i-- > 0) {
			var circleCollision = this.circleCollisions[i];
			if(circleCollision.remove == true) {
				this.circleCollisions[i] = this.circleCollisions[--l];
				this.pool.alloc(circleCollision);
				continue;
			}
			var k = flash._Vector.Vector_Impl_.get_length(this.circleCollisions);
			while(k-- > 0) {
				var circleCollision2 = this.circleCollisions[k];
				if(circleCollision != circleCollision2) {
					var dx = circleCollision.position.x - circleCollision2.position.x;
					var dy = circleCollision.position.y - circleCollision2.position.y;
					var r = circleCollision.circle.radius + circleCollision2.circle.radius;
					if(dx * dx + dy * dy < r * r) {
						var p = new flash.geom.Point(dx,dy);
		...
		if(l < this.circleCollisions.length) this.circleCollisions = this.circleCollisions.slice(0,l);
		while(l > this.circleCollisions.length) this.circleCollisions.push(null);
		l;
	}
	,get: function() {
		var circleCollision = this.pool.get();
		if(circleCollision == null) circleCollision = new graphite.std.CircleCollisionComp();
		flash._Vector.Vector_Impl_.push(this.circleCollisions,circleCollision);
		return circleCollision;
	}
	,__class__: graphite.std.CircleCollisionSub
});
graphite.std.CircleComp = function(_radius,_lineColor,_fillColor) {
	this.radius = _radius;
	this.lineColor = _lineColor;
	this.fillColor = _fillColor;
	graphite.Comp.call(this,graphite.std.StdComp.CIRCLE);
};
$hxClasses["graphite.std.CircleComp"] = graphite.std.CircleComp;
graphite.std.CircleComp.__name__ = ["graphite","std","CircleComp"];
graphite.std.CircleComp.__super__ = graphite.Comp;
graphite.std.CircleComp.prototype = $extend(graphite.Comp.prototype,{
	unload: function() {
		flash.Lib.get_current().get_stage().removeChild(this.shape);
	}
	,load: function() {
		this.shape = new flash.display.Shape();
		this.redraw();
		flash.Lib.get_current().get_stage().addChild(this.shape);
	}
	,redraw: function() {
		this.shape.get_graphics().lineStyle(1,this.lineColor);
		this.shape.get_graphics().beginFill(this.fillColor);
		this.shape.get_graphics().drawCircle(0,0,this.radius);
	}
	,cache: function() {
		this.position = this.getComponentCache(graphite.std.StdComp.POSITION);
	}
	,__class__: graphite.std.CircleComp
});
graphite.std.CircleSub = function() {
	graphite.Sub.call(this,10,graphite.std.StdComp.CIRCLE);
	this.circles = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
};
$hxClasses["graphite.std.CircleSub"] = graphite.std.CircleSub;
graphite.std.CircleSub.__name__ = ["graphite","std","CircleSub"];
graphite.std.CircleSub.__super__ = graphite.Sub;
graphite.std.CircleSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.circles);
		var l = i;
		while(i-- > 0) {
			var circle = this.circles[i];
			if(circle.remove == true) {
				this.circles[i] = this.circles[--l];
		...
		if(l < this.circles.length) this.circles = this.circles.slice(0,l);
		while(l > this.circles.length) this.circles.push(null);
		l;
	}
	,get: function() {
		var circle = this.pool.get();
		if(circle == null) circle = new graphite.std.CircleComp(10,0,0);
		flash._Vector.Vector_Impl_.push(this.circles,circle);
		return circle;
	}
	,__class__: graphite.std.CircleSub
});
graphite.std.CoordinateComp = function(_x,_y) {
	if(_y == null) _y = 0;
	if(_x == null) _x = 0;
	graphite.Comp.call(this,graphite.std.StdComp.COORDINATES);
	this.x = _x;
	this.y = _y;
};
$hxClasses["graphite.std.CoordinateComp"] = graphite.std.CoordinateComp;
graphite.std.CoordinateComp.__name__ = ["graphite","std","CoordinateComp"];
graphite.std.CoordinateComp.__super__ = graphite.Comp;
graphite.std.CoordinateComp.prototype = $extend(graphite.Comp.prototype,{
	__class__: graphite.std.CoordinateComp
});
graphite.std.LerpComp = function(_factor) {
	if(_factor == null) _factor = 0.25;
	graphite.Comp.call(this,graphite.std.StdComp.LERP);
	this.factor = _factor;
};
$hxClasses["graphite.std.LerpComp"] = graphite.std.LerpComp;
graphite.std.LerpComp.__name__ = ["graphite","std","LerpComp"];
graphite.std.LerpComp.__super__ = graphite.Comp;
graphite.std.LerpComp.prototype = $extend(graphite.Comp.prototype,{
	load: function() {
		this.position.dampX = this.factor;
		this.position.dampY = this.factor;
	}
	,cache: function() {
		this.destination = this.getComponentCache(graphite.std.StdComp.COORDINATES);
		this.position = this.getComponentCache(graphite.std.StdComp.POSITION);
	}
	,__class__: graphite.std.LerpComp
});
graphite.std.LerpSub = function() {
	graphite.Sub.call(this,2,graphite.std.StdComp.LERP);
	this.lerps = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
};
$hxClasses["graphite.std.LerpSub"] = graphite.std.LerpSub;
graphite.std.LerpSub.__name__ = ["graphite","std","LerpSub"];
graphite.std.LerpSub.__super__ = graphite.Sub;
graphite.std.LerpSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.lerps);
		var l = i;
		while(i-- > 0) {
			var lerp = this.lerps[i];
			if(lerp.remove == true) {
				this.lerps[i] = this.lerps[--l];
		...
		if(l < this.lerps.length) this.lerps = this.lerps.slice(0,l);
		while(l > this.lerps.length) this.lerps.push(null);
		l;
	}
	,get: function() {
		var lerp = this.pool.get();
		if(lerp == null) lerp = new graphite.std.LerpComp(0.02);
		flash._Vector.Vector_Impl_.push(this.lerps,lerp);
		return lerp;
	}
	,__class__: graphite.std.LerpSub
});
graphite.std.MouseCoordComp = function() {
	graphite.Comp.call(this,graphite.std.StdComp.MOUSECOORDS);
};
$hxClasses["graphite.std.MouseCoordComp"] = graphite.std.MouseCoordComp;
graphite.std.MouseCoordComp.__name__ = ["graphite","std","MouseCoordComp"];
graphite.std.MouseCoordComp.__super__ = graphite.Comp;
graphite.std.MouseCoordComp.prototype = $extend(graphite.Comp.prototype,{
	cache: function() {
		this.coordinates = this.getComponentCache(graphite.std.StdComp.COORDINATES);
	}
	,__class__: graphite.std.MouseCoordComp
});
graphite.std.MouseCoordSub = function() {
	graphite.Sub.call(this,1,graphite.std.StdComp.MOUSECOORDS);
	this.mouseCoords = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
};
$hxClasses["graphite.std.MouseCoordSub"] = graphite.std.MouseCoordSub;
graphite.std.MouseCoordSub.__name__ = ["graphite","std","MouseCoordSub"];
graphite.std.MouseCoordSub.__super__ = graphite.Sub;
graphite.std.MouseCoordSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.mouseCoords);
		var l = i;
		while(i-- > 0) {
			var mouseCoord = this.mouseCoords[i];
			if(mouseCoord.remove == true) {
				this.mouseCoords[i] = this.mouseCoords[--l];
				this.pool.alloc(mouseCoord);
				continue;
			}
			mouseCoord.coordinates.x = flash.Lib.get_current().get_stage().get_mouseX();
			mouseCoord.coordinates.y = flash.Lib.get_current().get_stage().get_mouseY();
			if(!js.Boot.__instanceof(mouseCoord.coordinates.x,Float) || !js.Boot.__instanceof(mouseCoord.coordinates.x,Float)) {
				mouseCoord.coordinates.x = 0;
				mouseCoord.coordinates.y = 0;
			}
		}
		if(l < this.mouseCoords.length) this.mouseCoords = this.mouseCoords.slice(0,l);
		while(l > this.mouseCoords.length) this.mouseCoords.push(null);
		l;
	}
	,get: function() {
		var mouseCoord = this.pool.get();
		if(mouseCoord == null) mouseCoord = new graphite.std.MouseCoordComp();
		flash._Vector.Vector_Impl_.push(this.mouseCoords,mouseCoord);
		return mouseCoord;
	}
	,__class__: graphite.std.MouseCoordSub
});
graphite.std.PositionComp = function(_x,_y) {
	if(_y == null) _y = 0;
	if(_x == null) _x = 0;
	this.x = _x;
	this.y = _y;
	this.velX = this.velY = this.accX = this.accY = 0;
	this.dampX = this.dampY = 1;
	graphite.Comp.call(this,graphite.std.StdComp.POSITION);
};
$hxClasses["graphite.std.PositionComp"] = graphite.std.PositionComp;
graphite.std.PositionComp.__name__ = ["graphite","std","PositionComp"];
graphite.std.PositionComp.__super__ = graphite.Comp;
graphite.std.PositionComp.prototype = $extend(graphite.Comp.prototype,{
	__class__: graphite.std.PositionComp
});
graphite.std.PositionSub = function() {
	graphite.Sub.call(this,3,graphite.std.StdComp.POSITION);
	this.positions = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
};
$hxClasses["graphite.std.PositionSub"] = graphite.std.PositionSub;
graphite.std.PositionSub.__name__ = ["graphite","std","PositionSub"];
graphite.std.PositionSub.__super__ = graphite.Sub;
graphite.std.PositionSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.positions);
		var l = i;
		while(i-- > 0) {
			var position = this.positions[i];
			if(position.remove == true) {
				this.positions[i] = this.positions[--l];
		...
		if(l < this.positions.length) this.positions = this.positions.slice(0,l);
		while(l > this.positions.length) this.positions.push(null);
		l;
	}
	,get: function() {
		var position = this.pool.get();
		if(position == null) position = new graphite.std.PositionComp();
		flash._Vector.Vector_Impl_.push(this.positions,position);
		return position;
	}
	,__class__: graphite.std.PositionSub
});
graphite.std.RandomCoordComp = function(_dimensions,_timer) {
	if(_timer == null) _timer = 40;
	this.dimensions = _dimensions;
	this.timer = _timer;
	if(this.dimensions == null) this.dimensions = new flash.geom.Rectangle(0,0,800,600);
	graphite.Comp.call(this,graphite.std.StdComp.RANDOMCOORDS);
};
$hxClasses["graphite.std.RandomCoordComp"] = graphite.std.RandomCoordComp;
graphite.std.RandomCoordComp.__name__ = ["graphite","std","RandomCoordComp"];
graphite.std.RandomCoordComp.__super__ = graphite.Comp;
graphite.std.RandomCoordComp.prototype = $extend(graphite.Comp.prototype,{
	cache: function() {
		this.coordinates = this.getComponentCache(graphite.std.StdComp.COORDINATES);
	}
	,__class__: graphite.std.RandomCoordComp
});
graphite.std.RandomCoordSub = function() {
	graphite.Sub.call(this,1,graphite.std.StdComp.RANDOMCOORDS);
	this.randomCoords = flash._Vector.Vector_Impl_._new();
	this.pool = new graphite.collections.ObjectPool(10);
};
$hxClasses["graphite.std.RandomCoordSub"] = graphite.std.RandomCoordSub;
graphite.std.RandomCoordSub.__name__ = ["graphite","std","RandomCoordSub"];
graphite.std.RandomCoordSub.__super__ = graphite.Sub;
graphite.std.RandomCoordSub.prototype = $extend(graphite.Sub.prototype,{
	update: function() {
		var i = flash._Vector.Vector_Impl_.get_length(this.randomCoords);
		var l = i;
		while(i-- > 0) {
			var randomCoord = this.randomCoords[i];
			if(randomCoord.remove == true) {
				this.randomCoords[i] = this.randomCoords[--l];
		...
		if(l < this.randomCoords.length) this.randomCoords = this.randomCoords.slice(0,l);
		while(l > this.randomCoords.length) this.randomCoords.push(null);
		l;
	}
	,get: function() {
		var randomCoord = this.pool.get();
		if(randomCoord == null) randomCoord = new graphite.std.RandomCoordComp();
		flash._Vector.Vector_Impl_.push(this.randomCoords,randomCoord);
		return randomCoord;
	}
	,__class__: graphite.std.RandomCoordSub
});
graphite.std.StdComp = $hxClasses["graphite.std.StdComp"] = { __ename__ : true, __constructs__ : ["POSITION","CIRCLE","LERP","COORDINATES","MOUSECOORDS","RANDOMCOORDS","CIRCLECOLLISION"] }
graphite.std.StdComp.POSITION = ["POSITION",0];
graphite.std.StdComp.POSITION.toString = $estr;
graphite.std.StdComp.POSITION.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.CIRCLE = ["CIRCLE",1];
graphite.std.StdComp.CIRCLE.toString = $estr;
graphite.std.StdComp.CIRCLE.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.LERP = ["LERP",2];
graphite.std.StdComp.LERP.toString = $estr;
graphite.std.StdComp.LERP.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.COORDINATES = ["COORDINATES",3];
graphite.std.StdComp.COORDINATES.toString = $estr;
graphite.std.StdComp.COORDINATES.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.MOUSECOORDS = ["MOUSECOORDS",4];
graphite.std.StdComp.MOUSECOORDS.toString = $estr;
graphite.std.StdComp.MOUSECOORDS.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.RANDOMCOORDS = ["RANDOMCOORDS",5];
graphite.std.StdComp.RANDOMCOORDS.toString = $estr;
graphite.std.StdComp.RANDOMCOORDS.__enum__ = graphite.std.StdComp;
graphite.std.StdComp.CIRCLECOLLISION = ["CIRCLECOLLISION",6];
graphite.std.StdComp.CIRCLECOLLISION.toString = $estr;
graphite.std.StdComp.CIRCLECOLLISION.__enum__ = graphite.std.StdComp;
graphite.ui.KC8Button = function(_label,_width,_height,__callback) {
	if(_height == null) _height = 20;
	if(_width == null) _width = 100;
	if(_label == null) _label = "default";
	graphite.ui.KC8Object.call(this);
	this.background = new flash.display.Shape();
	this.background.get_graphics().lineStyle(1,Std.parseInt(graphite.ui.KC8UI.configOptions.chrome_color_1));
	this.background.get_graphics().beginFill(Std.parseInt(graphite.ui.KC8UI.configOptions.chrome_color_2));
	this.background.get_graphics().drawRect(0,0,_width,_height);
	this.addChild(this.background);
	this.label = new flash.text.TextField();
	this.label.set_defaultTextFormat(graphite.ui.KC8UI.textFormat);
	this.label.set_text(_label);
	this.label.mouseEnabled = false;
	this.label.selectable = false;
	this.addChild(this.label);
	this.darken = new flash.display.Shape();
	this.darken.get_graphics().beginFill(0);
	this.darken.alpha = 0.2;
	this.darken.get_graphics().drawRect(0,0,_width,_height);
	this.addChild(this.darken);
	this.darken.set_visible(false);
	this.addEventListener(flash.events.MouseEvent.ROLL_OVER,$bind(this,this.rollOver));
	this.addEventListener(flash.events.MouseEvent.ROLL_OUT,$bind(this,this.rollOut));
	this.label.set_width(_width);
	this.label.set_height(this.label.get_textHeight() > 20?this.label.get_textHeight():20);
	this.label.set_y((_height - this.label.get_textHeight()) * 0.5);
	this.addEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.down));
	this.buttonMode = true;
	this._callback = __callback;
};
$hxClasses["graphite.ui.KC8Button"] = graphite.ui.KC8Button;
graphite.ui.KC8Button.__name__ = ["graphite","ui","KC8Button"];
graphite.ui.KC8Button.__super__ = graphite.ui.KC8Object;
graphite.ui.KC8Button.prototype = $extend(graphite.ui.KC8Object.prototype,{
	release: function(e) {
		this.get_stage().removeEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.release));
		if(this.over == false) this.darken.set_visible(false); else this.darken.alpha = 0.05;
		if(this._callback != null && this.get_mouseX() > 0 && this.get_mouseX() < this.get_width() && this.get_mouseY() > 0 && this.get_mouseY() < this.get_height()) this._callback(this);
	}
	,down: function(e) {
		this.darken.set_visible(true);
		this.darken.alpha = 0.2;
		this.get_stage().addEventListener(flash.events.MouseEvent.MOUSE_UP,$bind(this,this.release));
	}
	,unload: function() {
		this.removeEventListener(flash.events.MouseEvent.MOUSE_DOWN,$bind(this,this.down));
		this.removeEventListener(flash.events.MouseEvent.ROLL_OVER,$bind(this,this.rollOver));
		this.removeEventListener(flash.events.MouseEvent.ROLL_OUT,$bind(this,this.rollOut));
		graphite.ui.KC8Object.prototype.unload.call(this);
	}
	,load: function() {
	}
	...
	,rollOut: function(e) {
		...
		this.darken.alpha = .2;
		this.over = false;
		if(this.get_stage() != null) this.release(null);
	}
	,get_label: function() {
		return this.label.get_text();
	}
	,__class__: graphite.ui.KC8Button
});
graphite.ui.KC8UI = function() { }
$hxClasses["graphite.ui.KC8UI"] = graphite.ui.KC8UI;
graphite.ui.KC8UI.__name__ = ["graphite","ui","KC8UI"];
graphite.ui.KC8UI.init = function(__callback) {
	graphite.ui.KC8UI.mcallback = __callback;
	graphite.ui.KC8UI.binloader = new graphite.io.BinaryLoader();
	graphite.ui.KC8UI.binloader.load("config.json",graphite.ui.KC8UI.configReady);
}
graphite.ui.KC8UI.configReady = function() {
	graphite.ui.KC8UI.configOptions = haxe.Json.parse(graphite.ui.KC8UI.binloader.data);
	graphite.ui.KC8UI.textFormat = new flash.text.TextFormat("verdana",12,graphite.ui.KC8UI.configOptions.text_color,null,null,null,null,null,flash.text.TextFormatAlign.CENTER);
	graphite.ui.KC8UI.textFormatLeft = new flash.text.TextFormat("verdana",12,graphite.ui.KC8UI.configOptions.text_color,null,null,null,null,null,flash.text.TextFormatAlign.LEFT);
	graphite.ui.KC8UI.glowFilter = new flash.filters.GlowFilter(0,0.7,10,10,1,5);
	graphite.ui.KC8UI.mcallback();
}
